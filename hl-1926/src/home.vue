...
<style lang="less">
    body{
      // background-image: -webkit-linear-gradient(bottom left, rgba(0, 0, 255, 0.5), rgba(255, 0, 0, 0.75)), -webkit-linear-gradient(rgba(0, 0, 255, 0.25) 100%, transparent), url("./assets/img/2019.jpeg");
      // background-image: linear-gradient(to top right, rgba(0, 0, 255, 0.5), rgba(255, 0, 0, 0.75)), linear-gradient(rgba(0, 0, 255, 0.25) 100%, transparent), url("./assets/img/2019.jpeg");
...
<script>
import hlWarp from './hl.vue'
import menuWarp from './menu.vue'
export default {
    components: {
      hlWarp,
      menuWarp
