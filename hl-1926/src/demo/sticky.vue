<template>
  <article>
    <div>
      <img src="../assets/511YJ-2.jpg" alt="" style="width:100%;min-height:100px">
    </div>
    <sticky>
      <div onselectstart="return false;" class="w-flexbox w-tab">
        <span v-for="item in tabs" :name="item.name" :key="item.key">{{item.label}}</span>
      </div>
    </sticky>
...
<script>
import Sticky from "@/componentss/sticky";
export default {
  components: {
    Sticky
  },
