            ...
            <div class="info-list">
                        ...
                        <div class="aplayer-controller">
                            ...
                            <div class="aplayer-time">
                                <div class="aplayer-time-inner">
                                    {{ currentTimeMaxTime | formatSecond }} / {{ currentTime | formatSecond }}
                                </div>
                            </div>
                        </div>
                    </div>
                    <audio ref="audio" src="" @play="onPlay" @timeupdate="onTimeupdate" @loadedmetadata="onLoadedmetadata"></audio>
                </div>
                <!--当个音频播放-->
                <div class="">
                    <audio ref="audio" src="" @play="onPlay" @timeupdate="onTimeupdate" @loadedmetadata="onLoadedmetadata"></audio>
                ...
                <ul class="list">
                    <li class="audio-item" :class="playing && cur_music == index ? 'active':''" v-for="(item,index) in list" >
                        <!--是否是整个点击-->
                        <button class="i-play" :data-index="index">
...
export default {
    ...
    mounted() {
        //console.log(Array.isArray(this.aplayerParm.videoData))
        //console.log(Object.prototype.toString.call(this.aplayerParm.videoData));// [object Object]
    },
    updated () {
    },
    methods:{
