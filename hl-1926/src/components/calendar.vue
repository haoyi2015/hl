    ...
    >
      <div class="calendar-title">
        ...
        <div class="calendar-title-choose">
          <span class="calendar-title-icon calendar-title-icon-left" @click="preMonth"><i class="iconfont icon-go-left"></i></span>
          <span class="calendar-title-show"><span>{{year}} - {{month}}</span></span>
          <span class="calendar-title-icon calendar-title-icon-right" @click="nextMonth"><i class="iconfont icon-go-right"></i></span>
        </div>
...
<script>
import Calendar from '@/util/calendar/chinese-calendar';
import HolidayData from '@/util/calendar/holiday.data';
export default {
  /***
    ...
    chooseDate (params) {
      if (!params.disabled) {
        ...
        let result = {
          ...
          m: arr[1],
          d: arr[2],
          id: (this.params&&this.params.id)?this.params.id:''
        };
