<template>
  <div>
    ...
    <a class="weui-btn weui-btn_plain-primary" @click="confirmHandleOpen2">confirm内容弹窗</a><br />
...
export default {
  ...
  methods: {
    confirmHandleOpen1() {
        this.$confirm({message: '<div class="aaaa">确认删除？</div>',title:'标题'}).then(() => {
            console.log('confirm')
          }).catch(() => {
            console.log('cancel')
          })
    ...
    confirmHandleOpen2 () {
        let str = `<div style="line-height:1.6;font-size:15px;padding-bottom:12px">
          长内容长内容长内容长内容长内容长内容长长内容长内容长内容长内容长内容长
          内容长内容长内容长内容长内容长内容长内容长内容长内容长内容内容长内容长内
          容长内容长内容长内容长内容长内容长内容
          长内容长内容长内容长内容长内容长内容长长内容长内容长内容长内容长内容长
