<template>
  <div>
      <span>注意：此示例要在移动设备体验哦~</span>
      <a @click="picker" href="javascript:;"
        class="weui-btn weui-btn_plain-default">
        地区 picker
      </a>
      <a @click="pickerList" href="javascript:;"
        class="weui-btn weui-btn_plain-default">
        地址级联 picker
      </a>
    <popup-picker
...
<script>
import PopupPicker from '../componentss/PopupPicker'
let citys = {
  '01': [
    {
      value: '0101',
