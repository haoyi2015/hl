...
<style media="screen">
    ...
    .w-flexbox-item+.w-flexbox-item,
    .w-flexbox-item:first-child {
    ...
    classes () {
      ...
      for (let name in flexMap) {
        if (this[name] && flexMap[name][this[name]]) {
          array.push('w-' + flexMap[name][this[name]])
        }
      }
      return array
    }
