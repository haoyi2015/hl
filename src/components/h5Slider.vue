<template>
<article class="slider-warps">
    <div class="btn" ref='remove'>
        <span ref='btnImg' class="btn-move" @touchstart='touchStart' @touchmove='touchMove' @touchend='touchEnd' :style="slideEffect">
            </span>
    </div>
    ...
    methods: {
        ...
        touchMove: function(ev) {
            ...
            if (ev.touches.length == 1) {
                ...
                } else if (this.disX > 0 && this.disX <= (btnWidth-btnImg)+5) {
                    this.slideEffect = 'transform:translateX(' + this.disX + 'px)';
                    console.log(this.disX,btnWidth)
                    // 最大也只能等于删除按钮宽度
